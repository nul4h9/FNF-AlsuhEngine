...
function onCharMissPress(charType:String, charName:String, animationToPlay:String, direction:Int)
{
...
function onCharMissNote(note:Note, charType:String, charName:String, animationToPlay:String)
{
