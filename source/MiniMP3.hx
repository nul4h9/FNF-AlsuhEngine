...
class MiniMP3
{
	public static function decodeMP3(file:Bytes):MP3Data
	{
	...
	public static function encodeWav(data:MP3Data):Bytes
	{
		var nbit:Int = 16;
		...
		bo.writeString("RIFF");
		bo.writeInt32(36 + (data.sampleCount));
		bo.writeString("WAVE");
		bo.writeString("fmt ");
		bo.writeInt32(16);
		bo.writeInt16(FORMAT_PCM);
		bo.writeInt16(data.channels);
		bo.writeInt32(data.sampleRate);
		bo.writeInt32(data.sampleRate * nbyte);
		bo.writeInt16(nbyte);
		bo.writeInt16(nbit);
		bo.writeString("data");
		bo.writeInt32(data.sampleCount);
		bo.writeBytes(data.data, 0, data.sampleCount);
		return bo.getBytes();
	}
	...
	public static function rawBufferToBytes(raw:Star<Int8>, length:Int):Bytes
	{
		...
		NativeArray.setUnmanagedData(data, cast raw, length);
