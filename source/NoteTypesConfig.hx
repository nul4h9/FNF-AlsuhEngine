...
class NoteTypesConfig
{
	...
	public static function clearNoteTypesData():Void
	{
		return noteTypesData.clear();
	}
	...
	public static function loadNoteTypeData(name:String):Array<NoteTypeProperty>
	{
		...
		var str:String = Paths.getTextFromFile('custom_notetypes/$name.txt', null, false, true);
	...
	public static function applyNoteTypeData(note:Note, name:String):Void
	{
	...
	private static function _propCheckArray(obj:Dynamic, slice:String, setProp:Bool = false, valueToSet:Dynamic = null):Dynamic
	{
